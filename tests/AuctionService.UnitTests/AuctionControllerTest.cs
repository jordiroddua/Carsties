...
public class AuctionControllerTest
{
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionByIdDtoAsync(It.IsAny<Guid>())).ReturnsAsync(auction);
    ...
    {
        // arrange
        _auctionRepo.Setup(repo => repo.GetAuctionByIdDtoAsync(It.IsAny<Guid>()))
    ...
    [Fact]
    public async Task DeleteAuction_WithValidGuid_ReturnsOkResponse()
    {
        // arrange
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "test";
